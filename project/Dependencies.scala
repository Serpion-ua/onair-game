...
object Dependencies {
  ...
  object Common {
    private val slf4jVersion = "1.7.33"
    private val logbackVersion = "1.2.10"
    private val pureConfigVersion = "0.17.1"
    private val catsLogVersion = "2.2.0"
    private val monocleVersion = "3.0.0-M6"
    private val sttpVersion = "3.4.0"
    ...
    val scalaLogging = ("com.typesafe.scala-logging" %% "scala-logging"          % "3.9.4").exclude("org.slf4j", "slf4j")
  ...
  object Http4s {
    ...
    val deps          = Seq(server, client, circe, xml, dsl)
  }


  object Specs {
    val scalaTest                   = "org.scalatest"        %% "scalatest"                                % "3.2.9"
    val scalaCheckPlus              = "org.scalatestplus"    %% "scalacheck-1-15"                          % "3.2.9.0"
    val scalaCheckPlusMockito       = "org.scalatestplus"    %% "mockito-3-4"                              % "3.2.9.0"
    ...
    val webSocketClient             = "com.github.andyglow"  %% "websocket-scala-client"                   % "0.4.0"
  ...
  object SQL {
    ...
    val deps = Seq(h2Database, doobieH2, doobieHikari)
  }
